const Hero = () => {
  return (
    <div className="container mx-auto my-5">
      ...
      >
        <div className="bg-[#150B2BB3] rounded-3xl"></div>
        <div className="hero-content text-center text-neutral-content">
          <div>
            ...
            <p className="mb-5">
              ...
              <br />
              tailored to your skill level and culinary aspirations. From
              mastering basic techniques to exploring advanced <br /> flavors,
              discover your culinary potential with us."
            </p>
